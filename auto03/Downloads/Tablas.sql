...
CREATE TABLE band (band_no NUMBER(11) NOT NULL, 
...
CREATE TABLE composition (c_no NUMBER(11) NOT NULL, 
                            comp_date DATE, 
                            c_title VARCHAR(40) NOT NULL, 
                            c_in NUMBER(11));

CREATE TABLE concert (concert_no NUMBER(11) NOT NULL, 
                        concert_venue VARCHAR(20), 
                        concert_in NUMBER(11) NOT NULL, 
                        con_date DATE, 
                        concert_orgniser NUMBER(11));

CREATE TABLE has_composed (cmpr_no NUMBER(11) NOT NULL, 
                            cmpn_no NUMBER(11) NOT NULL);

CREATE TABLE musician (m_no NUMBER(11) NOT NULL,
                        m_name VARCHAR(20), 
                        born DATE, 
                        died DATE, 
                        born_in NUMBER(11), 
...
CREATE TABLE performance (pfrmnc_no NUMBER(11) NOT NULL, 
                            gave NUMBER(11), 
                            performed NUMBER(11), 
